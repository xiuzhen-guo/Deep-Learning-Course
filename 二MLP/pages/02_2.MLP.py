...
with tab1:
    ...
    with col1:
        st.image('./二MLP/图片10.png', caption='图10')
    """- 激活函数："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片11.png', caption='图11')
    """- MLP："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片12.png', caption='图12')
    """- 万有逼近定理："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片13.png', caption='图13')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片14.png', caption='图14')
...
with tab2:
    ...
    with col1:
        st.image('./二MLP/图片15.png', caption='图15')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片16.jpg', caption='图16')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片17.png', caption='图17')
    r"""$ \qquad \qquad $ """
    ...
    with col1:
        st.image('./二MLP/图片18.png', caption='图18 SGD')
    with col2:
        st.image('./二MLP/图片19.png', caption='图19 Momentum')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片20.png', caption='图20')
    r"""$ \qquad \qquad $ """
    ...
    with col1:
        st.image('./二MLP/图片21.gif', caption='图21')
    with col2:
        st.image('./二MLP/图片22.gif', caption='图22')
    _, col1, _= st.columns([1, 1.2, 1])
    with col1:
        st.image('./二MLP/图片23.gif', caption='图23')
    r"""$ \qquad $ 总结："""
...
with tab3:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片24.png', caption='图24')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片25.png', caption='图25')
    r"""$ \qquad $ 前向过程："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片26.png', caption='图26')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片27.png', caption='图27')
    _, col1, _ = st.columns([1, 4, 1])
    r"""$ \qquad $ 反向过程："""
    with col1:
        st.image('./二MLP/图片28.png', caption='图28')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片29.png', caption='图29')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片30.png', caption='图30')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片31.png', caption='图31')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片32.png', caption='图32')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片33.png', caption='图33')
    r"""$ \qquad $ 总结："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片34.png', caption='图34')
...
b.grad.data.zero_()
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片35.png', caption='图35')
...
""")
    ...
    with col1:
        st.image('./二MLP/图片36.png', caption='图36')
...
with tab5:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./二MLP/图片37.png', caption='图37')
...
"""
    ...
    with col1:
        st.image('./二MLP/图片38.png', caption='图38')
    r"""$ \qquad $ 工作流程："""
    r"""$ \qquad \qquad $ 假设我们要训练这样一个神经网络，如图所示。"""
    _, col1, _ = st.columns([1, 2, 1])
    with col1:
        st.image('./二MLP/图片39.png', caption='图39')
    ...
    _, col1, _ = st.columns([1, 2, 1])
    with col1:
        st.image('./二MLP/图片40.png', caption='图40')
