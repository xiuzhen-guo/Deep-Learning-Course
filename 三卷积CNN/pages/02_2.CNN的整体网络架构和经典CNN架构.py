...
with tab1:
    ...
    with col1:
        st.image('./三卷积CNN/图片14.png', caption='图14 常用的卷积网络整体结构')
...
with tab2:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片15.png', caption='图15 Lenet-5的网络结构')
    """- AlexNet"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片16.jpg', caption='图16 AlexNet的网络结构')
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片17.png', caption='图17 AlexNet的网络结构')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片18.png', caption='图18 VGGNet的网络结构')
    """- InceptionNet-V1 """
    r""" $ \qquad $ 简介："""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片19.png', caption='图19 Inception模块')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片20.png', caption='图20 InceptionNet-V1的网络结构')
    """- ResNet """
    r""" $ \qquad $ 简介："""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片21.png', caption='图21 残差模块')
...
with tab3:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片22.jpg', caption='图22 机器翻译任务')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片23.jpg', caption='图23 机器翻译示例图')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./三卷积CNN/图片24.webp', caption='图24 Attention机制图')
