...
with tab1:
    ...
    with col1:
        st.image('./六TL与DRL/图片1.png', caption='图1 TL示意图')
    """- TL的分类:"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./六TL与DRL/图片2.png', caption='图2')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./六TL与DRL/图片3.png', caption='图3')
...
"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./六TL与DRL/图片56.png', caption='图56')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./六TL与DRL/图片57.png', caption='图57')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./六TL与DRL/图片58.png', caption='图58')
