...
with tab1:
    ...
    with col1:
        st.image('./五生成模型/图片1.jpg', caption='图1 AE网络结构')
    """- AE优缺点:"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片2.jpg', caption='图2')
    """- AE的变体:"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片3.png', caption='图3')
...
with tab2:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片4.jpg', caption='图4')
    """- VAE-理论推导:"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片5.png', caption='图5')
    """- 重参数化:"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片6.png', caption='图6')
    """- VAE-学习到的隐变量流形:"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片7.png', caption='图7')
    """- VAE-网络结构:"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./五生成模型/图片8.png', caption='图8')
    """- VAE的优缺点:"""
    """$ \qquad $ 1.优点："""
