...
with tab2:
    ...
    with col1:
        st.image('./五生成模型/图片43.jpg', caption='图43')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片47.jpg', caption='图47')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片48.jpg', caption='图48')
    """$ \qquad $ 下面进一步地做推广，我们考虑z与x都是二维分布的情形。"""
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片49.jpg', caption='图49')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片50.png', caption='图50')
    """$ \qquad $ 其中"""
    st.latex(r"""det\left[
                        \begin{array}{cc}
...
with tab3:
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片60.png', caption='图60')
    """$ \qquad $ 将其取log，得到："""
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片61.png', caption='图61')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片62.jpg', caption='图62')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片63.jpg', caption='图63')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片64.png', caption='图64')
    """$ \qquad $ 其逆运算的计算式，即由x传给z的计算式，可以非常方便地推导出来为："""
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片65.png', caption='图65')
    """$ \qquad $ 上面我们说明了，这样设计的耦合层能快速计算出$G^{-1}$，下面我们来说明，其在G的Jacobian行列式的计算上也是非常简便。"""
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片66.jpg', caption='图66')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片69.jpg', caption='图69')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片70.jpg', caption='图70')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片71.jpg', caption='图71')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./五生成模型/图片72.jpg', caption='图72')
