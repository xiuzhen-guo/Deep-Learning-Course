...
with tab1:
    ...
    with col1:
        st.image('./四NLP/图片60.png', caption='图60')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片61.png', caption='图61')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片62.png', caption='图62')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片63.png', caption='图63')
    """- NLP有2个核心的任务："""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片64.png', caption='图64')
    """$ \qquad $ 自然语言理解的5个难点："""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片65.png', caption='图65')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片66.png', caption='图66')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片67.png', caption='图67')
    """- 情感分析"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片68.png', caption='图68')
    """$ \qquad $ 1.语料预处理"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片69.png', caption='图69')
    """$ \qquad $ 1.语料预处理"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片70.png', caption='图70')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片71.png', caption='图71')
...
with tab2:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片72.png', caption='图72')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片73.png', caption='图73')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片74.png', caption='图74')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片75.png', caption='图75')
    """ 区别1：分词方式不同，中文更难"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片76.png', caption='图76')
    """ 难点1：没有统一的标准"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片77.png', caption='图77')
    """ 分词地方法大致分为3类："""
    """$ \qquad $ 1.基于词典匹配"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片78.png', caption='图78')
    """- 2.什么是词干提取和词形还原？"""
    """ 词干提取 – Stemming"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片81.png', caption='图81')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片82.png', caption='图82')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片83.png', caption='图83')
    """ Porter"""
...
#Returns blog
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片84.png', caption='图84')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片85.png', caption='图85')

    """- 3.4类常见的实现方式"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片86.png', caption='图86')
...
with tab3:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片87.png', caption='图87')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片88.png', caption='图88')

    """- $\\textbf{2.独热编码 | one-hot representation}$"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片89.png', caption='图89')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片90.png', caption='图90')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片92.png', caption='图92')
    """ Word2vec"""
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片93.png', caption='图93')

    r"""$ \qquad \qquad \qquad $ CBOW模型包含3层，即输入层、映射层和输出层。"""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片2.png', caption='图2')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片94.png', caption='图94')

    r"""$ \qquad \qquad \qquad $ Skip-Gram模型同样包含3层，输入层，映射层和输出层。架构如图："""
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片3.png', caption='图3')
...
with tab4:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./四NLP/图片1.jpg', caption='图1 中文文本处理的一般步骤')
